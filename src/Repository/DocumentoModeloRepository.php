...
class DocumentoModeloRepository extends ServiceEntityRepository
{
    ...
    {
        $sql = "SELECT * 
                FROM homepet_{$baseId}.documento_modelo 
    ...
    {
        $this->conn->insert("homepet_{$baseId}.documento_modelo", [
    ...
    {
        $this->conn->update("homepet_{$baseId}.documento_modelo", [
            'titulo'    => $doc->getTitulo(),
            'tipo'      => $doc->getTipo(),
            'cabecalho' => $doc->getCabecalho(),
            'conteudo'  => $doc->getConteudo(),
    ...
    {
        $sql = "DELETE FROM homepet_{$baseId}.documento_modelo WHERE id = :id";
