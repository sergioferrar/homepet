...
class PetController extends DefaultController
{
    ...
    private $racas = ["Border Collie", "Poodle", "Pastor Alemão", "Golden Retriever", "Doberman Pinscher",
     ...
     * @
     */
    #[Route('dashboard/pet/', name: 'pet_index', methods: "{GET}")]
     ...
     * @
     */
    #[Route('dashboard/pet/novo', name: 'pet_novo', methods: "{GET, POST}")]
     ...
     * @
     */
    #[Route('dashboard/pet/editar/{id}', name: 'pet_editar', methods: "{GET, POST}")]
    public function editar(Request $request, int $id): Response
    {
        ...
        sort($this->racas, SORT_LOCALE_STRING);
     ...
     * @
     */
    #[Route('dashboard/pet/deletar/{id}', name: 'pet_deletar')]
     ...
     * @
     */
    #[Route('dashboard/pet/pet/cadastro', name: 'cadastro_pet')]
