...
class NotaFiscalController extends DefaultController
{
     ...
     * @
     */
    #[Route('dashboard/nota-fiscal', name: 'nf_lista')]
     ...
     *
     */
    #[Route('dashboard/nota-fiscal/emitir-venda/{vendaId}', name: 'nf_emitir_venda', methods: "{POST}")]
     ...
     * @
     */
    #[Route('dashboard/nota-fiscal/avulsa', name: 'nf_avulsa_form', methods: "{GET}")]
     ...
     * @
     */
    #[Route('dashboard/nota-fiscal/avulsa', name: 'nf_avulsa_store')]
     ...
     * @
     */
    #[Route('dashboard/nota-fiscal/autorizar/{id}', name: 'nf_autorizar', methods: "{POST}")]
    ...
    * @
    *
        #[Route("/cancelar/{id}", name: "nf_cancelar",]      methods={"POST"}, requirements={"id"="\d+"})
    */
    ...
    * @
    *
        #[Route("/sync/{id}", name: "nf_sync",]      methods={"POST"}, requirements={"id"="\d+"})
    */
     ...
     * @
     */
    #[Route('dashboard/nota-fiscal/webhook', name: 'nf_webhook')]
    public function webhook(Request $request, AsaasNotaFiscalService $asaas): JsonResponse
    {
        ...
        if ($tokenEsperado && $tokenEnviado !== $tokenEsperado) {
            return new JsonResponse(['ok' => false, 'msg' => 'Unauthorized'], \Symfony\Component\HttpFoundation\Response::HTTP_UNAUTHORIZED);
        }
     ...
     * @
     */
    #[Route('dashboard/nota-fiscal/configurar', name: 'nf_configurar', methods: "{GET}")]
     ...
     * @
     */
    #[Route('dashboard/nota-fiscal/configurar', name: 'nf_configurar_save')]
     ...
     * @
     */
    #[Route('dashboard/nota-fiscal/servicos-municipais', name: 'nf_servicos_municipais', methods: "{GET}")]
